...
def _comprehensive_response_payload(response: object) -> dict[str, object]:
    return {
        ...
        "candidates": _sanitize_payload_value(getattr(response, "candidates", ())),
        "task_candidates": _sanitize_payload_value(getattr(response, "task_candidates", ())),
        "task_change_candidates": _sanitize_payload_value(getattr(response, "task_change_candidates", ())),
        "event_candidates": _sanitize_payload_value(getattr(response, "event_candidates", ())),
        "event_change_candidates": _sanitize_payload_value(getattr(response, "event_change_candidates", ())),
        "schedule_candidates": _sanitize_payload_value(getattr(response, "schedule_candidates", ())),
        "server_operations": _sanitize_payload_value(getattr(response, "server_operations", ())),
        "approvals": _sanitize_payload_value(getattr(response, "approvals", ())),
