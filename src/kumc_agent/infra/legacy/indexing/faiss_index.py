...
from kumc_agent.infra.legacy.indexing.chunks import Chunk, chunk_embedding_text
from kumc_agent.infra.legacy.indexing.index_metadata import get_embedding_dimension, write_index_metadata
