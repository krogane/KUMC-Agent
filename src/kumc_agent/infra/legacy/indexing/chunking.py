...
from kumc_agent.infra.legacy.date_metadata import (
    SOURCE_DATE_UNKNOWN,
    infer_source_date,
    source_date_from_vc_path,
)
from kumc_agent.infra.legacy.indexing.chunks import Chunk, load_chunks, write_chunks
from kumc_agent.infra.legacy.indexing.constants import FILE_ID_SEPARATOR, MESSAGE_SEPARATORS
