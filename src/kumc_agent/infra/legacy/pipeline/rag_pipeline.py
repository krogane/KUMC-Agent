...
from kumc_agent.infra.legacy.date_metadata import SOURCE_DATE_UNKNOWN, infer_source_date, source_date_to_date
from kumc_agent.infra.legacy.indexing.chunks import load_chunks_from_dirs
from kumc_agent.infra.legacy.indexing.llm_client import generate_text
from kumc_agent.infra.legacy.indexing.material_catalog import MaterialCatalogEntry, load_material_catalog
...
from kumc_agent.infra.legacy.pipeline.vectorstore import load_faiss_index
